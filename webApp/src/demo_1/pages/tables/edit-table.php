...
?>
    ...
    <form name="form" method="post" action="edit-img.php" enctype="multipart/form-data" onsubmit="return(validate());" >
      <div class="row">
    <div class="col-sm-6">
      <table>
        <tr>
          <td><label > Id :</label></td>
          <td> <input type="text" name="idd" size="5" value= <?php echo $row['id'];?> readonly="true"></td>
        </tr>
          <td><label> URL </label></td>
          <td><input type="text" name="urll" size="50" value="<?php echo $row['url'] ?>"></td>
        </tr>
        <tr>
          <td>Image </td>
          <td> <div class="col">
      <img id="blah" height="52" width="52" src=" <?php echo $row['url'] ?>">
    </div> </td>
        </tr>
        <tr>
          <td><label> status </label> </td>
          <td> <input type="text" name="sts" size="5" value="<?php echo $row['status'] ?>"></label></td>
        </tr>
        <tr>
          <td> </td>
          <td> <input type="file" name="my_file" id="files"  onclick="del_img();" onchange="readURL(this);"/></td>
        </tr>
        <tr>
          <td> <input type="submit" name="submit"  value="Save"/> </td>
          <td> <input type="Button" name="btn" onclick="go_to_dashboard();" value="Close"/></td>
        </tr>
