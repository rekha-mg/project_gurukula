...
echo $sql="SELECT * FROM user WHERE Email_id='$eml' ";
//exit;
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="navbar-nav ml-auto align-items-center">
						...
						<li class="nav-item">
						<a class="nav-link btn btn-success" href="#contact"><?php  echo $name;  ?></a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div class="col-sm-7" data-aos="fade-up" data-aos-offset="-500">
							...
							<form action="mailsend.php" method="POST">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											<input type="email" name="emaill" class="form-control" id="mail" placeholder="Email*">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
